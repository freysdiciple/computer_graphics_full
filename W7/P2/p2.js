...
window.onload = () => {
    ...
    let ambientLight = vec3(1, 1, 1); // Set ambient light to a non-zero value
    ...
    function render() {
        ...
        gl.uniformMatrix4fv(gl.getUniformLocation(program, "u_Mtex"), false, flatten(Mtex)); 
        gl.uniformMatrix4fv(u_M, false, flatten(mat4()));
        drawBackgroundQuad(); 
